...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-fbjs/node_modules/fbjs/lib/UnicodeHangulKorean.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-fbjs/node_modules/fbjs/lib/UnicodeHangulKorean.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-fbjs/node_modules/fbjs/lib/</a> &#187; UnicodeHangulKorean.js</div>
</div>
<div class="body">
 ...
 * @param {string} str
 */
<span class="fstat-no" title="function not covered" >function hasCompatibilityOrSyllable(str) {</span>
<span class="cstat-no" title="statement not covered" >  return HANGUL_COMPATIBILITY_OR_SYLLABLE_REGEX.test(str);</span>
}
&nbsp;
 ...
 * @output {string}
 */
<span class="fstat-no" title="function not covered" >function fromCompatibility(codePoint) {</span>
<span class="cstat-no" title="statement not covered" >  return String.fromCharCode(CMAP[codePoint - CBASE]);</span>
}
&nbsp;
/**
 ...
 * @output {string}
 */
<span class="fstat-no" title="function not covered" >function decomposeSyllable(codePoint) {</span>
<span class="cstat-no" title="statement not covered" >  var sylSIndex = codePoint - SBASE;</span>
<span class="cstat-no" title="statement not covered" >  var sylTIndex = sylSIndex % TCOUNT;</span>
<span class="cstat-no" title="statement not covered" >  return String.fromCharCode(LBASE + sylSIndex / NCOUNT) + String.fromCharCode(VBASE + sylSIndex % NCOUNT / TCOUNT) + (sylTIndex &gt; 0 ? String.fromCharCode(TBASE + sylTIndex) : '');</span>
}
&nbsp;
/* To Conjoining Jamo */
&nbsp;
 ...
 * @output {string}
 */
<span class="fstat-no" title="function not covered" >function toConjoiningJamo(string) {</span>
<span class="cstat-no" title="statement not covered" >  if (!hasCompatibilityOrSyllable(string)) {</span>
...
<span class="cstat-no" title="statement not covered" >    var charStr = string.charAt(i);</span>
<span class="cstat-no" title="statement not covered" >    var codeUnit = charStr.charCodeAt(0);</span>
<span class="cstat-no" title="statement not covered" >    result.push(CBASE &lt;= codeUnit &amp;&amp; codeUnit &lt; CTOP ? fromCompatibility(codeUnit) : SBASE &lt;= codeUnit &amp;&amp; codeUnit &lt; STOP ? decomposeSyllable(codeUnit) : charStr);</span>
  }
